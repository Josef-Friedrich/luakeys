...
\begin{multicols}{2}
\InputLatex[firstline=5,lastline=12]{luakeysdebug/boolean.tex}
...
\begin{multicols}{2}
\InputLatex[firstline=5,lastline=13]{luakeysdebug/number.tex}
...
\InputLatex[firstline=5,lastline=21]{luakeysdebug/dimension/all.tex}
...
\begin{multicols}{2}
\InputLatex[firstline=5,lastline=12]{luakeysdebug/dimension/notations.tex}
