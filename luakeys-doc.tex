...
local kv = luakeys.parse(
  'level1={level2={naked,dim=1cm,bool=true,num=-0.001,str=lua}}',
...
(/home/jf/texmf/tex/luatex/luakeys/luakeys.sty)
(/usr/local/texlive/texmf-dist/tex/latex/l3backend/l3backend-luatex.def)
...
, 4 attribute_list, 1 write nodes
   avail lists: 2:23,3:4,4:2,5:22,6:2,7:40,9:18,11:2
</usr/local/texlive/texmf-dist/fonts/opentype/public/lm/lmroman10-regular.otf>
Output written on debug.pdf (1 page, 3193 bytes).
