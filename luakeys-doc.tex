...
\inputminted[firstline=4,lastline=16]{lua}{examples/definitions/options/sub-keys.lua}
...
\inputminted[firstline=4,lastline=11]{lua}{examples/functions/render.lua}
