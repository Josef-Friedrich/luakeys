...
\begin{enumerate}
\item \lua{kv_string}
\item \lua{keys_before_opts}
\item \lua{result_before_opts}
\item \lua{keys_before_def}
\item \lua{result_before_def}
\item \lua{process} (See definition)
\item \lua{keys_at_end}
\item \lua{result_at_end}
\end{enumerate}
...
\InputLuaExample[firstline=4,lastline=16]{hooks/keys-at-end.lua}
