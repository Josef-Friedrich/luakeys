...
The option \lua{group_begin} configures the delimiter that marks the beginning of a group.
...
The option \lua{group_end} configures the delimiter that
...
The option \lua{list_separator} configures the delimiter that
separates list items from each other.
A code example can be found in section \ref{options-delimiter}.
...
The option \lua{quotation_begin} configures the delimiter that
...
The option \lua{quotation_end} configures the delimiter that marks
the end of a string.
A code example can be found in section \ref{options-delimiter}.
