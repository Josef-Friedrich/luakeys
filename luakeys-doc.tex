...
in an object.
% Die Klasse stellt eine \lua{parse}-Methode bereit, die mit diesen
% Definitionen konfiguriert ist.
The class provides a \lua{parse} method that is configured with these
definitions.
...
\subsection{Method “\texttt{:set(def)}”}

\InputLua[firstline=13,lastline=14]{definition-manager/set.lua}

\subsection{Method “\texttt{:get(): Definition}”}

\InputLua[firstline=13,lastline=13]{definition-manager/set.lua}
