...
%
% Die Funktion ermöglicht es nicht nur in \LaTeX{}, sondern auch in Plain
% \TeX{} nach optionalen Argumenten zu suchen.
The function \\ \lua{luakeys.utils.scan_oarg(initial_delimiter?,
...
The function is based on the token library.
%
% Die beiden Parameter können weggelassen werden.
The two parameters can be omitted.
%
