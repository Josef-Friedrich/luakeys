...
\InputLua[firstline=3,lastline=12]{export.lua}
...
\InputLua[firstline=4,lastline=7]{opts/convert-dimensions.lua}

\noindent
By default the dimensions are not converted into scaled points.

\InputLua[firstline=13,lastline=18]{opts/convert-dimensions.lua}

\noindent
If you want to convert a scale point into a unit string you can use the
module
...
\InputLua[firstline=5,lastline=41]{defs/all-attrs.lua}
...
\InputLua[firstline=4,lastline=6]{defs/attrs/match.lua}
...
\InputLua[firstline=14,lastline=17]{defs/attrs/match.lua}
...
\InputLua[firstline=22,lastline=23]{defs/attrs/match.lua}
...
\InputLua[firstline=29,lastline=29]{defs/attrs/match.lua}
...
\InputLua[firstline=4,lastline=5]{defs/attrs/name.lua}

\noindent
% ... können wir schreiben:
... we can write:

\InputLua[firstline=11,lastline=15]{defs/attrs/name.lua}
...
Only the current results table is searched, not other levels in the
...
\InputLua[firstline=4,lastline=9]{defs/attrs/pick.lua}
...
return value is passed to the key. Four parameters are passed when the
function is called:
...
\InputLua[firstline=4,lastline=14]{defs/attrs/process.lua}

\noindent
The following example demonstrates the \lua{input} parameter:

\InputLua[firstline=22,lastline=34]{defs/attrs/process.lua}

\noindent
The following example demonstrates the \lua{result} parameter:

\InputLua[firstline=42,lastline=50]{defs/attrs/process.lua}

\noindent
The following example demonstrates the \lua{unknown} parameter:

\InputLua[firstline=58,lastline=65]{defs/attrs/process.lua}
\InputLua[firstline=69,lastline=69]{defs/attrs/process.lua}
...
\InputLua[firstline=7,lastline=23]{is-table.lua}

\subsubsection{Function \texttt{is.dimension(value): boolean}}
\InputLua[firstline=27,lastline=37]{is-table.lua}

\subsubsection{Function \texttt{is.integer(value): boolean}}
\InputLua[firstline=41,lastline=46]{is-table.lua}

\subsubsection{Function \texttt{is.number(value): boolean}}
\InputLua[firstline=50,lastline=57]{is-table.lua}

\subsubsection{Function \texttt{is.string(value): boolean}}
\InputLua[firstline=61,lastline=67]{is-table.lua}
...
\InputLatex[firstline=5,lastline=12]{luakeysdebug/naked-keys.tex}
...
\InputLatex[firstline=14,lastline=19]{luakeysdebug/naked-keys.tex}
...
\InputLatex{extend-includegraphics/extend-keys.tex}
...
\InputLatex{class-options/use-test-class.tex}
